...
[Anthropic Claude](https://www.anthropic.com/) (claude-sonnet-5 by default) analyzes code with rich contextual information. The retrieved context is combined with the code being reviewed and sent to Claude, which performs a comprehensive analysis considering:
